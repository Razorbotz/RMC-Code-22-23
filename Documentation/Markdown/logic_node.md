...
##### This function is used to set the motor speeds to zero.  It was assumed that the motors would automatically zero themselves out upon the robot restart, but this wasn’t always the case.  Thus, this function ensures that the robot won’t start up and do odd things, like run into walls.
#### Expected Input
##### N/A
#### Expected Results
